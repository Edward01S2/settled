...
$(document).ready(function () {
  ...
  function update() {
    ...
    tl = gsap__WEBPACK_IMPORTED_MODULE_4__["gsap"].fromTo('.process-carousel #slide-1 #circle', {
      x: 0,
      scale: 1
    }, {
      x: circle,
  ...
  $(window).smartresize(function (e) {
    if ($('.process-carousel').length) {
      drag.resize(); //console.log('resized')
  ...
  gsap__WEBPACK_IMPORTED_MODULE_4__["gsap"].fromTo('.split-video #in-anim', {
    autoAlpha: 0
  }, {
    scrollTrigger: {
      trigger: '.split-video',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_4__["gsap"].fromTo('.split-video #video-link-line', {
    xPercent: -100
  }, {
    scrollTrigger: {
